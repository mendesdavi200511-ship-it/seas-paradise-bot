...
def obter_limite_dominio(tipo, nome):
    """
    Retorna o limite máximo de porcentagem do domínio.

    Profissões usam o máximo definido no próprio catálogo.
    Ex:
        Cozinheiro = 200%
        Cientista = 400%

    Os demais usam 200% por enquanto.
    """
