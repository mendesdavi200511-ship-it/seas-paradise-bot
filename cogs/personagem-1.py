...
# =====================================================
    ...
    async def resetarficha(
        ...
        # Localiza o tópico ANTES de apagar os dados da ficha.
        # Faz busca no tópico atual, cache, API de threads ativas e
        # arquivos públicos/privados do canal oficial.
        thread = None
        canal = None
        ...
        # Se o reset foi executado dentro do tópico que acabou de ser apagado,
        # não tentamos responder naquele canal inexistente.
        if thread_apagada and isinstance(ctx.channel, discord.Thread) and ctx.channel.id == thread.id:
            return
