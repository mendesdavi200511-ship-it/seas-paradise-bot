...
Identifique SOMENTE personagens NPC que realmente aparecem,
falam, são abordados ou são diretamente mencionados nessa cena.
...
""".strip()
        ...
        resposta = await self.client.responses.create(
            ...
            instructions=(
                ...
                "Sua única função é identificar NPCs explicitamente presentes "
                "ou mencionados na cena. Não invente nomes."
            ),
            input=entrada,
