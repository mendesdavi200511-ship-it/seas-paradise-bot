...
""".strip()
    ...
    async def acao(self, ctx, *, texto: str):
        ...
        async with locks[cena_id]:
            ...
            # Sessão compartilhada: criada na primeira ação válida do canal.
            local_real = estado_atual["localizacao"] if estado_atual else local_canal
            area_real = estado_atual["area"] if estado_atual and estado_atual["area"] else None
            sessao = await obter_ou_criar_sessao(
